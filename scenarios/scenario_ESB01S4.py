...
ARQUIVO_RESULTADOS_CSV_HOST = OUTPUT_DIR_HOST / 'result_run_ESB01S4.csv'
JSON_SAIDA = str(PROJECT_ROOT / 'output' / 'topologia_ESB01S4.json')
...
ARQUIVO_RESULTADOS_CSV_CONT = "/app/output/result_run_ESB01S4.csv"
...
def run_scenario():
    ...
    with mosaik.World(SIM_CONFIG) as world:
        ...
        # ====================================================================
        # MONITORES DE TODAS AS BARRAS (CSV) - (Descomente para simulação completa)
        # ====================================================================
        ...
        # TESTE RÁPIDO: pegando apenas as 5 primeiras barras para não pesar a simulação
        ...
        # ====================================================================
        # MONITORES DE TODAS AS LINHAS (Corrente e Potência) - (Descomente para simulação completa)
        # ====================================================================
        ...
        # TESTE RÁPIDO: pegando apenas as 5 primeiras linhas para não pesar a simulação
